...
if sidebar_option == "Player Profile":
    ...
    if option == "Batsman Analysis":
        ...
        if not bat_choices:
            ...
            # -------------------------
            # Wagon Wheel (8 sectors) - sector-label style with Third Man at 10:30-12:00
            # -------------------------
            ...
            # base_angles adjusted for Third Man between 10:30 and 12:00, moving left by 45° each
            def get_sector_angle_requested(zone, batting_style):
                base_angles = {
                    1: 75,   # Third Man (center of 10:30-12:00, i.e., 11:15 = 75°)
                    2: 30,   # Point
                    3: 345,  # Covers
                    4: 300,  # Mid-off
                    5: 255,  # Mid-on
