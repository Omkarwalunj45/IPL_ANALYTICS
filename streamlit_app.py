...
# with the code below:
        ...
        if option == "Batting":          
            ...
            # Split data for pace and spin - THIS IS THE KEY FIX
           ...
           'Right-arm medium fast and off-break']
            ...
            allowed_batting_styles = ['LHB', 'RHB']
            result_df = pd.DataFrame()
            ...
            if not final_df.empty:     
                ...
                for _, row in final_df.iterrows():
                    ...
                    line_idx = line_positions.get(line, 2)
                    length_idx = length_positions.get(length, 2)
